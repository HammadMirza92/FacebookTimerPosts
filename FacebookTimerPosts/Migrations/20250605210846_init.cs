    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 6, 5, 21, 8, 46, 99, DateTimeKind.Utc).AddTicks(9068), "Free plan with basic features", 0, true, 1, 7, "Free", 0m, null },
                    { 2, new DateTime(2025, 6, 5, 21, 8, 46, 99, DateTimeKind.Utc).AddTicks(9136), "Professional plan with advanced features", 30, true, 10, 20, "Pro", 20m, null },
                    { 3, new DateTime(2025, 6, 5, 21, 8, 46, 99, DateTimeKind.Utc).AddTicks(9140), "Premium plan with all features", 30, true, 20, 0, "Premium", 50m, null }
                });
